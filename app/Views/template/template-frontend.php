...
<head>
    ...
    <title>PPDB Cepu Kotaa Minyak</title>
...
<body class="hold-transition layout-top-nav">
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand-md navbar-light navbar-white">
            <div class="container">
                <a href="<?= base_url('/') ?>" class="navbar-brand">
                    ...
                    <span class="brand-text font-weight-light"><b>PPDB Cepu Kota Minyak</b></span>
                </a>
        ...
        <footer class="main-footer">
            <!-- To the right -->
            <!-- Default to the left -->
            <strong>Abdullah Nasih Jasir - 5025211111</a> - </strong> Pemrograman Berbasis Kerangka Kerja (A)
        </footer>
    </div>
    <!-- ./wrapper -->
