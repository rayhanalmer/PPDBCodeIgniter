    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="d-block w-100" height="420px" src="<?= base_url('ppdb/ppdb1.png') ?>" alt="First slide">
            </div>
            ...
            <div class="col-md-12 col-sm-12 col-12">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        ...
                        <span class="info-box-number">12076</span>
                    </div>
                    <!-- /.info-box-content -->
                </div>
                <!-- /.info-box -->
            ...
            <div class="col-md-12 col-sm-12 col-12">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        ...
                        <span class="info-box-number">12073</span>
                    </div>
                    <!-- /.info-box-content -->
                </div>
                <!-- /.info-box -->
